...
const AlertSuccess: React.FunctionComponent<AlertSuccessProps> = ({ message, title, closeFunction }) => {
  return (
    <div className="mt-12 mx-4 px-4 rounded-md border-l-4 border-green-500 bg-green-50 md:max-w-2xl md:mx-auto md:px-8">
      <div className="flex justify-between py-3">
        ...
        <button onClick={closeFunction} className="self-start text-green-500">
